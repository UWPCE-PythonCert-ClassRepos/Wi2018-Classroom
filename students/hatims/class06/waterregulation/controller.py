...
class Controller(object):
    ...
    def tick(self):
        ...
        """
        current_height_of_iquid_in_tank = self.sensor.measure()
        pump_current_state = self.pump.get_state()
        next_pump_state = self.decider.decide(current_height_of_iquid_in_tank, \
                                              pump_current_state, self.actions)
        result = self.pump.set_state(next_pump_state)
