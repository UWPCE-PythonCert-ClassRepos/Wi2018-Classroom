...
p = hr.P("1-Here is a paragraph of text -- there could be more of them, but this is enough  to show that we can do some text")
print(p.content)

body.append(hr.P("1-Here is a paragraph of text -- there could be more of them, but this is enough  to show that we can do some text"))

body.append(hr.P("2-And here is another piece of text -- you should be able to add any number"))
