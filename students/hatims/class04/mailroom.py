...
_donors = Donors()
_donors.add_donor('William Gates', [7897100.00, 5000.00, 12000000.00])
_donors.add_donor('Mark Zuckerberg', [19000.00, 8900000.00])
_donors.add_donor('Jeff Bezos', [1000.00, 1445600.00])
_donors.add_donor('Paul Allen', [9000.00, 29000000.00, 5690000000.00])

def save_donors(_donors):
    with open("donors.json", 'w') as tempfile:
        tempfile.write(str(_donors.to_json()))
