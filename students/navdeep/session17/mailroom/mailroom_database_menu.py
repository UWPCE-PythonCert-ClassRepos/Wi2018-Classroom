import os.path
from populate_mailroom import ManipulateDB
...
def addNewDonation(donor_collection_obj, first_name, last_name, email):
    ...
    donor_collection_obj.add_donor(first_name, last_name, email, new_donation)
...
def delete_instance(donor_collection_obj):
    ...
    while invalid == True:
        try:
            ...
            if del_email == "" or not donor_collection_obj.donor_exists(del_email):
                raise ValueError
        except ValueError:
            print("\nEmail does not exist in database.\n")
        else:
            invalid = False
    donor_collection_obj.delete_donation(del_email)
