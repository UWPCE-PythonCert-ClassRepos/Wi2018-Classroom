...
class Decider(object):
    ...
    def decide(self, current_height, current_action, actions):
        ...
        """
        # Mindlessly following the steps above leads to pretty bad code:
        #
        # if current_action == "PUMP_OFF" and current_height < self.target_height:
        #     return actions['PUMP_IN']
        # elif current_action != "PUMP_OUT" and current_height > ideal_margins[1]:
        #     return actions["PUMP_OUT"]
        # elif current_action == "PUMP_OFF" and current_height > ideal_margins[0] and current_height < ideal_margins[1]:
        #     return "stay off!"
        # elif current_action == "PUMP_IN" and current_height > ideal_margins[0]:
        ...
        ideal_margins = [self.target_height - self.margin, self.target_height + self.margin]

        if current_height < ideal_margins[0] : 
            return actions["PUMP_IN"]
        elif current_height > ideal_margins[1]:
            return actions["PUMP_OUT"]
        else:
            return actions["PUMP_OFF"]
